// JS Recon v8 — paste into browser console on target site
...
// ---------- fingerprint / jwt ----------
// global-based detectors: [name, fn -> version | true (detected, unknown ver) | falsy]
var DET=[
  // frameworks / view
  ['React',function(){return window.React?(window.React.version||true):(window.__REACT_DEVTOOLS_GLOBAL_HOOK__||document.querySelector('[data-reactroot]')?true:false);}],
  ['ReactDOM',function(){return window.ReactDOM?(window.ReactDOM.version||true):false;}],
  ['Next.js',function(){return window.__NEXT_DATA__?((window.__NEXT_DATA__.buildId&&'build:'+window.__NEXT_DATA__.buildId)||true):false;}],
  ['Preact',function(){return (window.preact||window.__PREACT_DEVTOOLS__)?true:false;}],
  ['Vue',function(){return window.Vue?(window.Vue.version||true):((window.__VUE__||document.querySelector('[data-v-app]'))?true:false);}],
  ['Nuxt',function(){return window.__NUXT__?true:false;}],
  ['AngularJS',function(){return window.angular?((window.angular.version&&window.angular.version.full)||true):false;}],
  ['Svelte',function(){return (window.__svelte||document.querySelector('[class*="svelte-"]'))?true:false;}],
  ['Ember',function(){return window.Ember?(window.Ember.VERSION||true):false;}],
  ['Backbone',function(){return window.Backbone?(window.Backbone.VERSION||true):false;}],
  ['Knockout',function(){return window.ko?(window.ko.version||true):false;}],
  ['Alpine.js',function(){return window.Alpine?(window.Alpine.version||true):false;}],
  ['Solid',function(){return window._$HY?true:false;}],
  // utility
  ['Lodash',function(){return (window._&&window._.VERSION&&window._.chunk)?window._.VERSION:((window.lodash&&window.lodash.VERSION)||false);}],
  ['Underscore',function(){return (window._&&window._.VERSION&&!window._.chunk&&window._.template)?window._.VERSION:false;}],
  ['Ramda',function(){return window.R&&window.R.__&&window.R.map?true:false;}],
  ['Moment.js',function(){return window.moment?(window.moment.version||true):false;}],
  ['Day.js',function(){return window.dayjs?true:false;}],
  ['axios',function(){return window.axios?(window.axios.VERSION||true):false;}],
  ['RxJS',function(){return window.rxjs?true:false;}],
  ['Redux',function(){return (window.__REDUX_DEVTOOLS_EXTENSION__||window.Redux)?true:false;}],
  ['MobX',function(){return (window.__mobxGlobals||window.mobx)?true:false;}],
  ['Immutable',function(){return window.Immutable?(window.Immutable.version||true):false;}],
  ['core-js',function(){return window['__core-js_shared__']?true:false;}],
  ['Modernizr',function(){return window.Modernizr?true:false;}],
  // data / viz
  ['D3',function(){return window.d3?(window.d3.version||true):false;}],
  ['Chart.js',function(){return window.Chart?(window.Chart.version||true):false;}],
  ['Three.js',function(){return window.THREE?('r'+(window.THREE.REVISION||'?')):false;}],
  ['Highcharts',function(){return window.Highcharts?(window.Highcharts.version||true):false;}],
  ['ECharts',function(){return window.echarts?(window.echarts.version||true):false;}],
  ['Plotly',function(){return window.Plotly?(window.Plotly.version||true):false;}],
  ['Leaflet',function(){return window.L&&window.L.version?window.L.version:false;}],
  ['Mapbox GL',function(){return window.mapboxgl?(window.mapboxgl.version||true):false;}],
  ['ApexCharts',function(){return window.ApexCharts?true:false;}],
  ['PixiJS',function(){return window.PIXI?(window.PIXI.VERSION||true):false;}],
  // animation / ui widgets
  ['GSAP',function(){return window.gsap?(window.gsap.version||true):(window.TweenMax||window.TweenLite?true:false);}],
  ['Anime.js',function(){return window.anime?(window.anime.version||true):false;}],
  ['Lottie',function(){return window.lottie?true:false;}],
  ['Swiper',function(){return window.Swiper?true:false;}],
  ['Bootstrap',function(){return window.bootstrap?((window.bootstrap.Modal&&window.bootstrap.Modal.VERSION)||true):false;}],
  ['Popper',function(){return window.Popper?(window.Popper.version||true):false;}],
  ['jQuery UI',function(){return window.jQuery&&window.jQuery.ui?(window.jQuery.ui.version||true):false;}],
  ['Handlebars',function(){return window.Handlebars?(window.Handlebars.VERSION||true):false;}],
  ['Mustache',function(){return window.Mustache?(window.Mustache.version||true):false;}],
  ['Select2',function(){return window.jQuery&&window.jQuery.fn&&window.jQuery.fn.select2?true:false;}],
  ['DataTables',function(){return window.jQuery&&window.jQuery.fn&&window.jQuery.fn.DataTable?((window.jQuery.fn.dataTable&&window.jQuery.fn.dataTable.version)||true):false;}],
  ['SweetAlert',function(){return (window.Swal||window.swal)?true:false;}],
  ['Toastr',function(){return window.toastr?true:false;}],
  ['CKEditor',function(){return (window.CKEDITOR||window.ClassicEditor)?true:false;}],
  ['TinyMCE',function(){return window.tinymce?((window.tinymce.majorVersion&&window.tinymce.majorVersion+'.'+window.tinymce.minorVersion)||true):false;}],
  ['Quill',function(){return window.Quill?true:false;}],
  ['CodeMirror',function(){return window.CodeMirror?(window.CodeMirror.version||true):false;}],
  ['Monaco',function(){return window.monaco?true:false;}],
  // realtime / net
  ['Socket.IO',function(){return window.io?(window.io.protocol?'proto'+window.io.protocol:true):false;}],
  ['SockJS',function(){return window.SockJS?true:false;}],
  // build tooling / data
  ['webpack',function(){return (window.webpackChunk||window.webpackJsonp||window.__webpack_require__)?true:false;}],
  ['Apollo',function(){return window.__APOLLO_CLIENT__?true:false;}],
  // analytics / 3rd-party
  ['Analytics/GTM',function(){return (window.gtag||window.ga||window.dataLayer||window.google_tag_manager)?true:false;}],
  ['Segment',function(){return window.analytics&&window.analytics.track?true:false;}],
  ['Mixpanel',function(){return window.mixpanel?true:false;}],
  ['Amplitude',function(){return window.amplitude?true:false;}],
  ['Hotjar',function(){return window.hj?true:false;}],
  ['Intercom',function(){return window.Intercom?true:false;}],
  ['Optimizely',function(){return window.optimizely?true:false;}],
  ['LaunchDarkly',function(){return window.LDClient?true:false;}],
  ['Sentry',function(){return window.Sentry?(window.Sentry.SDK_VERSION||true):false;}],
  ['Firebase',function(){return window.firebase?(window.firebase.SDK_VERSION||true):false;}],
  ['Stripe.js',function(){return window.Stripe?true:false;}],
  ['reCAPTCHA',function(){return window.grecaptcha?true:false;}],
  ['Turnstile',function(){return window.turnstile?true:false;}],
  ['Shopify',function(){return window.Shopify?true:false;}]
];
var LIBFILES=[['jquery','jQuery'],['lodash','Lodash'],['underscore','Underscore'],['moment','Moment.js'],['dayjs','Day.js'],['axios','axios'],['react-dom','ReactDOM'],['react','React'],['vue','Vue'],['angular','Angular'],['d3','D3'],['three','Three.js'],['chart','Chart.js'],['highcharts','Highcharts'],['echarts','ECharts'],['plotly','Plotly'],['gsap','GSAP'],['swiper','Swiper'],['bootstrap','Bootstrap'],['popper','Popper'],['leaflet','Leaflet'],['mapbox','Mapbox GL'],['handlebars','Handlebars'],['mustache','Mustache'],['backbone','Backbone'],['ember','Ember'],['rxjs','RxJS'],['redux','Redux'],['socket.io','Socket.IO'],['sockjs','SockJS'],['immutable','Immutable'],['modernizr','Modernizr'],['pixi','PixiJS'],['anime','Anime.js'],['lottie','Lottie'],['alpine','Alpine.js'],['knockout','Knockout'],['ramda','Ramda'],['core-js','core-js'],['select2','Select2'],['datatables','DataTables'],['slick','Slick'],['owl.carousel','Owl Carousel'],['aos','AOS'],['clipboard','clipboard.js'],['sweetalert','SweetAlert'],['toastr','Toastr'],['dropzone','Dropzone'],['ckeditor','CKEditor'],['tinymce','TinyMCE'],['quill','Quill'],['codemirror','CodeMirror'],['monaco','Monaco'],['pdf.','pdf.js'],['fontawesome','Font Awesome'],['font-awesome','Font Awesome']];
function fileInfer(add){
  var files=Array.from(D.jsfiles).concat(Array.from(D.urls));
  files.forEach(function(u){
    var name;try{name=u.split(/[?#]/)[0].split('/').pop().toLowerCase();}catch(e){name=(''+u).toLowerCase();}
    if(!name||(name.indexOf('.js')<0&&name.indexOf('.css')<0))return;
    LIBFILES.forEach(function(l){
      var kw=l[0].replace(/[.]/g,'\\.');
      if(new RegExp('(?:^|[^a-z0-9])'+kw+'(?:[^a-z]|$)').test(name)){
        var vm=name.match(new RegExp(kw+'[@\\-_/ ]?v?(\\d+\\.\\d+(?:\\.\\d+)?)'))||name.match(/[@\-_/ ]v?(\d+\.\d+(?:\.\d+)?)/);
        add(l[1],vm?vm[1]:true);
      }
    });
  });
}
function fingerprint(){
  var T=[],seen={};
  function add(n,v){
    v=(v===true||v===undefined||v===null||v==='')?'?':String(v).substring(0,40);
    if(seen[n]!==undefined){if(seen[n]==='?'&&v!=='?'){seen[n]=v;for(var i=0;i<T.length;i++){if(T[i]===n+' ?'||T[i].indexOf(n+' ')===0)T[i]=n+' '+v;}}return;}
    seen[n]=v;T.push(n+' '+v);
  }
  DET.forEach(function(d){try{var r=d[1]();if(r)add(d[0],r);}catch(e){}});
  try{var ng=document.querySelector('[ng-version]');if(ng)add('Angular',ng.getAttribute('ng-version'));}catch(e){}
  try{var gen=document.querySelector('meta[name="generator"]');if(gen&&gen.content)add('generator: '+gen.content.substring(0,40));}catch(e){}
  try{if(window.wp||document.querySelector('link[href*="wp-content"]'))add('WordPress');}catch(e){}
  try{fileInfer(add);}catch(e){}
  return T.sort();
}
